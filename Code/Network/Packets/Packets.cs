namespace L2_login
{
    ...
    enum PClientEX : byte
    {
        ...
        RequestExMPCCShowPartyMembersInfo = 0x2D,
        RequestOlympiadMatchList = 0x2E,

        RequestAskJoinPartyRoom = 0x2F,
        AnswerJoinPartyRoom = 0x30,
        RequestListPartyMatchingWaitingRoom = 0x31,
        RequestExEnchantSkillSafe = 0x32,
        RequestExEnchantSkillUntrain = 0x33,
        RequestExEnchantSkillRouteChange = 0x34,
        RequestExEnchantItemAttribute = 0x35,
        ExGetOnAirShip = 0x36,
        ExGetOffAirShip = 0x37, //*
        MoveToLocationAirShip = 0x38,
        CreateCharConfirm = 0x39,
        RequestBidItemAuction = 0x39,
        RequestInfoItemAuction = 0x3A,
        RequestExChangeName = 0x3B,
        RequestAllCastleInfo = 0x3C,
        RequestAllFortressInfo = 0x3D,
        RequestAllAgitInfo = 0x3E,

        RequestFortressSiegeInfo = 0x3F,
        RequestGetBossRecord = 0x40,
        RequestRefine = 0x41,
        RequestConfirmCancelItem = 0x42,
        RequestRefineCancel = 0x43,
        RequestExMagicSkillUseGround = 0x44,
        RequestDuelSurrender = 0x45,
        RequestExEnchantSkillInfoDetail = 0x46,
        RequestFortressMapInfo = 0x48, // Freya
        SetPrivateStoreWholeMsg = 0x4A,
        RequestDispel = 0x4B, // Freya
        RequestExTryToPutEnchantTargetItem = 0x4C,

        RequestExTryToPutEnchantSupportItem = 0x4D,
        RequestExCancelEnchantItem = 0x4E,
        RequestChangeNicknameColor = 0x4F,
        RequestResetNickname = 0x50,
